...
#Use cv2 to capture video from webcam
...
# Use the model "faster_rcnn_inception_resnet_v2_atrous_lowproposals_oid"
...
# ## Loading label map (name and number correspondence)
